...
eq::exp : {j : Level} -> _
eq::exp {j} = \(n : nat.nat) -> \(m : nat.nat) -> ((((connectives.equal::leibniz {_} {j}) (nat.nat)) (exp n m)) (nat.filter::nat::type (nat.nat) (exp::body n) m)) (((axiom::exp) (n)) (m))

sym::eq::exp : {j : Level} -> _
sym::eq::exp {j} = \(n : nat.nat) -> \(m : nat.nat) -> ((((leibniz.sym::leibniz {_} {j}) (nat.nat)) (exp n m)) (nat.filter::nat::type (nat.nat) (exp::body n) m)) (((eq::exp) (n)) (m))

postulate axiom::exp::body::O : forall (n : nat.nat) -> connectives.equal (nat.nat) (exp::body n nat.O) (nat.S nat.O)
eq::exp::body::O : {j : Level} -> _
eq::exp::body::O {j} = \(n : nat.nat) -> ((((connectives.equal::leibniz {_} {j}) (nat.nat)) (exp::body n nat.O)) (nat.S nat.O)) ((axiom::exp::body::O) (n))

sym::eq::exp::body::O : {j : Level} -> _
sym::eq::exp::body::O {j} = \(n : nat.nat) -> ((((leibniz.sym::leibniz {_} {j}) (nat.nat)) (exp::body n nat.O)) (nat.S nat.O)) ((eq::exp::body::O) (n))
...
eq::exp::body::S : {j : Level} -> _
eq::exp::body::S {j} = \(n : nat.nat) -> \(m : nat.nat) -> ((((connectives.equal::leibniz {_} {j}) (nat.nat)) (exp::body n (nat.S m))) (nat.times (exp n m) n)) (((axiom::exp::body::S) (n)) (m))

sym::eq::exp::body::S : {j : Level} -> _
sym::eq::exp::body::S {j} = \(n : nat.nat) -> \(m : nat.nat) -> ((((leibniz.sym::leibniz {_} {j}) (nat.nat)) (exp::body n (nat.S m))) (nat.times (exp n m) n)) (((eq::exp::body::S) (n)) (m))
